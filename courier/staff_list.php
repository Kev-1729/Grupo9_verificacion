	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_staff"><i class="fa fa-plus"></i> Agregar Nuevo</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.view_staff').click(function(){
			uni_modal("Detalle del Personal","view_staff.php?id="+$(this).attr('data-id'),"large")
		})
	$('.delete_staff').click(function(){
	_conf("Estás seguro de eliminar al personal?","delete_staff",[$(this).attr('data-id')])
	})
	})
	function delete_staff($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Información eliminada correctamente",'success')
					setTimeout(function(){
						location.reload()
					},1500)
