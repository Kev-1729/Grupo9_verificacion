<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			<label for="">Actualización de Estado</label>
			<?php $status_arr = array("Artículo Aceptado por el Mensajero", "Recogido", "Enviado", "En Tránsito", "Llegado al Destino", "En Reparto", "Listo para Recoger", "Entregado", "Recogido", "Intento de Entrega Fallido"); ?>
